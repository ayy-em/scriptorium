@.Codex/skills/terminal/terminal.md
@.Codex/skills/task-workflow/task-workflow.md
@.Codex/skills/code-style/code-style.md
@.Codex/skills/dependencies/dependencies.md
